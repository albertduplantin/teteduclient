...
const BiasCards = lazy(() => import('./BiasCards').then(module => ({ default: module.BiasCards })))
const SeriousModal = lazy(() => import('./SeriousModal').then(module => ({ default: module.SeriousModal })))
const PWAInstallButton = lazy(() => import('./PWAInstallButton').then(module => ({ default: module.PWAInstallButton })))
